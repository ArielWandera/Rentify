    ...
    <div className="max-w-7xl mx-auto px-6 py-10 space-y-6">
      ...
      <div className="card overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-dark-border">
              {logs.map(log => (
                <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-dark-elevated/50 transition">
                  <td className="px-5 py-3 text-warm-gray dark:text-gray-400 whitespace-nowrap">
        ...
        {meta && meta.last_page > 1 && (
          <div className="flex justify-between items-center px-5 py-4 border-t border-gray-100 dark:border-dark-border">
            <button
